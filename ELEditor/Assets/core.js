//飞地原生交互桥
function EnclaveBridge() {
}

// MARK: - Callbacks
EnclaveBridge.prototype.callback = function(callbackScheme, callbackPath) {
 ...
 */
EnclaveBridge.prototype.callbackThroughIFrame = function(url) {
...
EnclaveBridge.prototype.log = function(msg) {
    this.callback('callback-log', 'msg=' + msg);
};
