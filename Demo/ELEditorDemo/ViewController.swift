...
class ViewController: ELEditorViewController, ELEditorViewDelegate {
    ...
    @objc func onSwitchTheme(_ sender: Any!) {
        if let title = themeItem.title, title == "夜间模式" {
